"""
Django settings for ingenieriaWebProyectoColaborativo project.
...
ALLOWED_HOSTS = ['.render.com', "127.0.0.1", "https://ingenieriaweb-proyecto-iker-cubillo.onrender.com"]


# Application definition

INSTALLED_APPS = [
    'appIngenieriaWebProyectoColaborativo',
...
ROOT_URLCONF = 'ingenieriaWebProyectoColaborativo.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [BASE_DIR / "appIngenieriaWebProyectoColaborativo/templates"],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'ingenieriaWebProyectoColaborativo.wsgi.application'
